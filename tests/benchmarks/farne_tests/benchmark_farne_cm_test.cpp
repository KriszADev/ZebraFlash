...
// Base configuration tests for Farnebäck algorithm
TEST(BenchmarksTest, FarneMultiCPU_DefaultConfig) {
    BenchmarkHelpers::runBenchmarkTest(test_info_->name(), "FARNE", false, true,
        [](MotionDetector& d) {
...
TEST(BenchmarksTest, FarneMultiCPU_HighAccuracy) {
    BenchmarkHelpers::runBenchmarkTest(test_info_->name(), "FARNE", false, true,
        [](MotionDetector& d) {
            d.getConfig().pyr_scale = 0.5;
...
TEST(BenchmarksTest, FarneMultiCPU_FastProcessing) {
    BenchmarkHelpers::runBenchmarkTest(test_info_->name(), "FARNE", false, true,
        [](MotionDetector& d) {
            d.getConfig().pyr_scale = 0.5;
            d.getConfig().levels = 1;
...
TEST(BenchmarksTest, FarneMultiCPU_SensitiveDetection) {
    BenchmarkHelpers::runBenchmarkTest(test_info_->name(), "FARNE", false, true,
        [](MotionDetector& d) {
            d.getConfig().pyr_scale = 0.5;
...
TEST(BenchmarksTest, FarneMultiCPU_ConservativeDetection) {
    BenchmarkHelpers::runBenchmarkTest(test_info_->name(), "FARNE", false, true,
        [](MotionDetector& d) {
            d.getConfig().pyr_scale = 0.5;
            d.getConfig().levels = 3;
...
TEST(BenchmarksTest, FarneMultiCPU_LargeMotion) {
    BenchmarkHelpers::runBenchmarkTest(test_info_->name(), "FARNE", false, true,
        [](MotionDetector& d) {
...
TEST(BenchmarksTest, FarneMultiCPU_NoFrameLock) {
    BenchmarkHelpers::runBenchmarkTest(test_info_->name(), "FARNE", false, true,
        [](MotionDetector& d) {
            d.getConfig().pyr_scale = 0.5;
            d.getConfig().levels = 3;
...
TEST(BenchmarksTest, FarneMultiCPU_ExtendedFrameLock) {
    BenchmarkHelpers::runBenchmarkTest(test_info_->name(), "FARNE", false, true,
        [](MotionDetector& d) {
            d.getConfig().pyr_scale = 0.5;
            d.getConfig().levels = 3;
